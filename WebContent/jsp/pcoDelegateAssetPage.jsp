...
<div id="DHView">
	<h4 style="color: #336699">Delegate Project Tracks Under Delivery
		Head</h4>
									...
									<c:forEach var="e1"
										...
										<c:forEach var="emp" items="${e1.employeeBeans}">
											<c:forEach var="emp1" items="${emp.employeeBeans}">
												...
												<option
													value="${emp1.userId}/${emp1.employeeName}/${emp1.managerId}/${emp1.managerId2Up}">${emp1.employeeName}</option>
												</c:if>
											</c:forEach>
										</c:forEach>
									</c:forEach>
												...
												<c:forEach var="asset" items="${projectManager.assetBeans}">
													<tr>
														...
														<td style="text-align: right;"><input type="checkbox"
															class="${deliveryHead.userId}delegate" id="delegate"
