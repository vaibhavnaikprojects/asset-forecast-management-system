...
<title>Need Additional Info</title>
</head>
<body>
<div id="banner-image">
		  ...
		  <div class="panel panel-default">
		    <div class="panel-heading" role="tab" id="headingOne">
		      <h4 class="panel-title" style="color: #336699">
		       ...
		       Addition Information for Laptop request
		        </a>
		      </h4>
		    </div>

<form id="NeedAdditionalInfo" action="NeedAdditionalInfo.html" method="post" >
...
<label for="projectName">Enter Addition Information</label>
<textarea class="form-control" name="moreinfo" id="moreinfo" maxlength="2000" placeholder="Information required"
							required="required" cols="50" rows="5" ></textarea>
</div>
