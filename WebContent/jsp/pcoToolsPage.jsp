				...
				<div class="row">
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content" style="margin-top: 30%">
								<div class="modal-header">
									...
									<h4 class="modal-title" id="myModalLabel">Set Quarters For
										The Year</h4>
								</div>
								<form id="setQuarters" class="form-inline"
									...
									<div class="modal-body">
										...
										<div class="form-group" style="width: 100%">
											<br />
											<b>Quarter 1:</b><br /> <label for="quarter1from">From
												:</label>&nbsp;&nbsp;&nbsp; <input type="text" class="form-control"
												name="quarterfrom" id="quarter1from" required=""
										...
										<div class="form-group" style="width: 100%">
											<br />
											<b>Quarter 2:</b><br /> <label for="quarter2from">From
												:</label>&nbsp;&nbsp;&nbsp; <input type="text" class="form-control"
										...
										<div class="form-group" style="width: 100%">
											<br />
											<b>Quarter 3:</b><br /> <label for="quarter3from">From
												:</label>&nbsp;&nbsp;&nbsp; <input type="text" class="form-control"
										...
										<div class="form-group" style="width: 100%">
											<br />
											<b>Quarter 4:</b><br /> <label for="quarter4from">From
												:</label>&nbsp;&nbsp;&nbsp; <input type="text" class="form-control"
					...
					<div class="col-xs-3">
						...
						<ul class="nav nav-tabs tabs-left">
							<li class="active"><a href="#systemFreeze" data-toggle="tab">Maintain
									System Freeze</a></li>
							<li><a href="#maintainQuarters" data-toggle="tab">Maintain
									Quarters</a></li>
						</ul>
					</div>
					<div class="col-xs-9">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="systemFreeze">
								...
								<form action="systemFreeze.html" method="post"
									...
									<div class="form-group">
										<label for="freezeDate">Enter Date</label> <input
